...
//void Display(const SimpleCircleLinkList<ElemType> &list)    // 显示函数
//
...
int main( )
{
    ...
    cout <<"\t\t**************************************************** " <<endl;
    cout <<"\t\t**            Test SimpleCircleLinkList Of              **" <<endl;
    cout <<"\t\t****************************************************" <<endl;
    #endif
    ...
    SimpleCircleLinkList<int> list;       // 新建一个线性链表序列
...
//// 函数名称：void Display(const SimpleCircleLinkList<ElemType> &list)
