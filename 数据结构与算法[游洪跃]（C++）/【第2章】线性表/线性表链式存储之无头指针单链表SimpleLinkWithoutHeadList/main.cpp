...
#include "SimpleLinkWithoutHeadList.h"
...
//void Display(const SimpleLinkWithoutHeadList<ElemType> &list)    // 显示函数
//
...
int main( )
{
    ...
    cout <<"\t\t**************************************************** " <<endl;
    cout <<"\t\t**            Test SimpleLinkWithoutHeadList Of              **" <<endl;
    cout <<"\t\t****************************************************" <<endl;
    #endif
    ...
    SimpleLinkWithoutHeadList<int> list;       // 新建一个线性链表序列
    ...
    while( 1 )
    {
        ...
        switch(choice)
        {
          ...
          case 1:
            ...
            // SimpleLinkWithoutHeadList测试信息
            if(list.Length() > 0)       // 如果当前线性链表不为空
            {
                list.Clean( );          // 则先清空
            }
...
//// 函数名称：void Display(const SimpleLinkWithoutHeadList<ElemType> &list)
