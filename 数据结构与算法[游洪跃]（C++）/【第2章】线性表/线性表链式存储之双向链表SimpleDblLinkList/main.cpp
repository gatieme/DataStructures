...
//void Display(const SimpleDblLinkList<ElemType> &list)    // 显示函数
//
...
int main( )
{
    ...
    cout <<"\t\t**************************************************** " <<endl;
    cout <<"\t\t**            Test SimpleDblLinkList Of              **" <<endl;
    cout <<"\t\t****************************************************" <<endl;
    #endif
    ...
    SimpleDblLinkList<int> list;       // 新建一个线性链表序列
...
//// 函数名称：void Display(const SimpleDblLinkList<ElemType> &list)
