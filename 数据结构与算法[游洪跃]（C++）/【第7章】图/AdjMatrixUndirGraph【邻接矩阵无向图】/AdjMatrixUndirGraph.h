...
*  File Name  : main.cpp                                                     *
*  Description: 邻接矩阵无向图类AdjMatrixUndirGraph声明头文件                               *
*  Author     : Gatie_Me                                                     *
...
#ifndef ADJMATRIXUNDIRGRAPH_H_INCLUDED
#define ADJMATRIXUNDIRGRAPH_H_INCLUDED
...
/// 邻接矩阵无向图类AdjMatrixUndirGraph声明部分
template <class ElemType>
class AdjMatrixUndirGraph
{
    /*===========================【PUBLIC：公共接口】============================*/
public :      // 公共接口
    // 邻接矩阵无向图类AdjMatrixUndirGraph基本成员函数
    AdjMatrixUndirGraph( );         // 默认构造函数模版

    AdjMatrixUndirGraph(ElemType *vertex, int vexNum);  // 构造顶点数据为vertex, 顶点个数为vexNum的无向图

    AdjMatrixUndirGraph(int vexNum);                    // 构造顶点个数为vexNum的无向图

    AdjMatrixUndirGraph(const AdjMatrixUndirGraph<ElemType> &copy); // 复制构造函数

    AdjMatrixUndirGraph<ElemType>& operator=(const AdjMatrixUndirGraph<ElemType> &copy);    // 重载赋值运算符函数

    ~AdjMatrixUndirGraph( );                            // 析构函数

    // 邻接矩阵无向图类AdjMatrixUndirGraph特征成员函数
...
protected ://summit, peak, apex, zenith, acme, vertex
    // 邻接矩阵无向图类AdjMatrixUndirGraph数据成员
    ...
    // 邻接矩阵无向图类AdjMatrixUndirGraph辅助函数模版
...
/**邻接矩阵无向图类AdjMatrixUndirGraph辅助函数模版[实现]***********************************
    void DestroyGraph( );                // 销毁无向图, 释放无向图的空间
...
***********************************[实现]邻接矩阵无向图类AdjMatrixUndirGraph辅助函数模版**/
//// 函数名称：void DestroyGraph( );
//// 操作结果：销毁无向图, 释放无向图的空间
//template <class ElemType>
//void AdjMatrixUndirGraph<ElemType>::CreateGraph(int vertexNum)
//{
//#ifdef DEBUG    // 插桩调试信息
...
// 操作结果：销毁无向图, 释放无向图的空间
template <class ElemType>
void AdjMatrixUndirGraph<ElemType>::DestroyGraph( )
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
template <class ElemType>
void AdjMatrixUndirGraph<ElemType>::DFS(int vertex, void (* Visit)(const ElemType &))     // 从顶点vertex出发进行深度优先搜索
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
template <class ElemType>
void AdjMatrixUndirGraph<ElemType>::BFS(int vertex, void (* Visit)(const ElemType &))     // 从顶点vertex出发进行广度优先搜索
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
/**邻接矩阵无向图类AdjMatrixUndirGraph基本成员函数[实现]***********************************
    AdjMatrixUndirGraph( );         // 默认构造函数模版
    AdjMatrixUndirGraph(ElemType *vertex, int vexNum);  // 构造顶点数据为vertex, 顶点个数为vexNum的无向图
    AdjMatrixUndirGraph(int vexNum);                    // 构造顶点个数为vexNum的无向图
    AdjMatrixUndirGraph(const AdjMatrixUndirGraph<ElemType> &copy); // 复制构造函数
    AdjMatrixUndirGraph<ElemType>& operator=(const AdjMatrixUndirGraph<ElemType> &copy);    // 重载赋值运算符函数
    ~AdjMatrixUndirGraph( );                            // 析构函数
***********************************[实现]邻接矩阵无向图类AdjMatrixUndirGraph基本成员函数**/
// 函数名称：AdjMatrixUndirGraph( );         // 默认构造函数模版
// 操作方法：构造顶点数据为vertex, 顶点个数为vexNum的无向图
template <class ElemType>
AdjMatrixUndirGraph<ElemType>::AdjMatrixUndirGraph( )         // 默认构造函数模版
{
    m_vertexSize = 0;                       // 顶点个数
    m_edgeSize = 0;                      // 边数
    m_matrix = NULL;                     // 邻接矩阵
...
// 函数名称：AdjMatrixUndirGraph(ElemType *vertex, int vexNum);
// 操作方法：构造顶点数据为vertex, 顶点个数为vexNum的无向图
template <class ElemType>
AdjMatrixUndirGraph<ElemType>::AdjMatrixUndirGraph(ElemType *vertexs, int vertexNum)  // 构造顶点数据为vertex, 顶点个数为vexNum的无向图
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
// 函数名称：AdjMatrixUndirGraph(int vexNum);
// 操作方法：构造顶点个数为vexNum的无向图
template <class ElemType>
AdjMatrixUndirGraph<ElemType>::AdjMatrixUndirGraph(int vertexNum)                    // 构造顶点个数为vexNum的无向图
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
// 函数名称：AdjMatrixUndirGraph(const AdjMatrixUndirGraph<ElemType> &copy);
// 操作结果：复制构造函数
template <class ElemType>
AdjMatrixUndirGraph<ElemType>::AdjMatrixUndirGraph(const AdjMatrixUndirGraph<ElemType> &copy) // 复制构造函数
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
// 函数名称：AdjMatrixUndirGraph<ElemType>& operator=(const AdjMatrixUndirGraph<ElemType> &copy);
// 操作结果：重载赋值运算符函数
template <class ElemType>
AdjMatrixUndirGraph<ElemType>& AdjMatrixUndirGraph<ElemType>::operator=(const AdjMatrixUndirGraph<ElemType> &copy)    // 重载赋值运算符函数
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
// 函数名称：~AdjMatrixUndirGraph( );
// 操作结果：析构函数
template <class ElemType>
AdjMatrixUndirGraph<ElemType>::~AdjMatrixUndirGraph( )                            // 析构函数
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
/**邻接矩阵无向图类AdjMatrixUndirGraph特征成员函数[实现]***********************************
    int GetVertex(ElemType &elem);      // 获取当前顶点信息在原图中的位置
...
***********************************[实现]邻接矩阵无向图类AdjMatrixUndirGraph特征成员函数**/
//函数名称：int GetVertex(ElemType &elem);
//操作结果：获取当前顶点信息在原图中的位置
template <class ElemType>
int AdjMatrixUndirGraph<ElemType>::GetVertex(ElemType &elem)      // 获取当前顶点信息在原图中的位置
{
...
//操作结果：显示图的邻接矩阵信息
template <class ElemType>
void AdjMatrixUndirGraph<ElemType>::ShowMarix( )      // 显示图的邻接矩阵信息
{
...
//操作结果：修改图的顶点数和边数
template <class ElemType>
void AdjMatrixUndirGraph<ElemType>::SetGraph(ElemType *vertexs, int vertexNum)            // 修改图的顶点数和边数
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
// 操作结果：求顶点的元素值
template <class ElemType>
ElemType AdjMatrixUndirGraph<ElemType>::GetVertexElem(int vertex)                       // 求顶点的元素值
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
// 操作结果： 设置顶点的元素值
template <class ElemType>
bool AdjMatrixUndirGraph<ElemType>::SetElem(int vertex, const ElemType elem)      // 设置顶点的元素值
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
// 操作结果： 获取顶点的数目
template <class ElemType>
int AdjMatrixUndirGraph<ElemType>::GetVertexCount( )               // 获取顶点的数目
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
// 操作结果： 获取边的数目
template <class ElemType>
int AdjMatrixUndirGraph<ElemType>::GetEdgeCount( )                // 获取边的数目
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
template <class ElemType>
int AdjMatrixUndirGraph<ElemType>::FirstAdjVertex(int vertex)     // 获取顶点vertex的第一个邻接点
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
template <class ElemType>
int AdjMatrixUndirGraph<ElemType>::NextAdjVertex(int vertex1, int vertex2)    // 返回顶点vertex1相对于vertex2的下一个邻接点
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
template <class ElemType>
bool AdjMatrixUndirGraph<ElemType>::InsertEdge(int vertex1, int vertex2)            // 插入vertex1与vertex2的边
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
    ...
    if(m_matrix[vertex1][vertex2] == 0 && m_matrix[vertex2][vertex1] == 0)
    {
...
template <class ElemType>
bool AdjMatrixUndirGraph<ElemType>::DeleteEdge(int vertex1, int vertex2)          // 删除vertex1与vertex2的边
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
template <class ElemType>
bool AdjMatrixUndirGraph<ElemType>::GetVisited(int vertex)                        // 返回顶点vertex的访问标识信息
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
template <class ElemType>
void AdjMatrixUndirGraph<ElemType>::SetVisited(int vertex, bool isVisited)        // 设置顶点vertex的访问信息
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
template <class ElemType>
void AdjMatrixUndirGraph<ElemType>::DFSTraverse(void (* Visit)(const ElemType &))      // 深度优先搜素
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
template <class ElemType>
void AdjMatrixUndirGraph<ElemType>::DFSTraverse(int vertex, void (* Visit)(const ElemType &))      // 深度优先搜素
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
// 操作结果：广度优先搜素
template <class ElemType>
void AdjMatrixUndirGraph<ElemType>::BFSTraverse(void (*Visit)(const ElemType &))      // 广度优先搜素
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
// 操作结果：广度优先搜素
template <class ElemType>
void AdjMatrixUndirGraph<ElemType>::BFSTraverse(int vertex, void (*Visit)(const ElemType &))      // 广度优先搜素
{
#ifdef DEBUG    // 插桩调试信息
    std::cout <<"FUN:"<<__func__  <<", LINE:" <<__LINE__ <<std::endl;   // 输出函数信息
#endif
...
#endif // ADJMATRIXUNDIRGRAPH_H_INCLUDED
